...
class Settings:
    version: str = "5.3.0 Myeongha Integrated Final"
...
class App:
    def __init__(self):self.started=False;self.start_lock=threading.Lock();self.today="";self.stage_alert={};self.brief_sent={};self.last_daily_refresh={};self.last_outcome_check=0.0
