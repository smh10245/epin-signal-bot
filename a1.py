...
class Settings:
    version: str = "5.4.3 Myeongha Low-Load Finder + Durable VIP Guard"
...
class Store:
    def __init__(self):
        self.vip=DATA_DIR/"vip_targets.json";self.vip_bak=DATA_DIR/"vip_targets.backup.json";self.pos=DATA_DIR/"positions.json";self.sig=DATA_DIR/"signal_history.json";self.trade=DATA_DIR/"trade_history.json";self.master=DATA_DIR/"stock_master.json"
